                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="productdate" id="txtNgayNhap" class="form-control"
                                               value="{{$row->productdate}}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="short_description" id="txtMotangan" class="form-control ckeditor"
                                              style="height: 200px;">{{$row->short_description}}</textarea>
